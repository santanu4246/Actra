...
import { screenGradientColors, SCREEN_GRADIENT_LOCATIONS, SCREEN_GRADIENT_TOP } from "@/constants/brand";
...
export default function GoalFrequencyScreen() {
  ...
  const { topic, hours, minutes } = useLocalSearchParams<{ topic: string, hours: string, minutes: string }>();
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionCard,
                    {
                      backgroundColor: isLight ? "#F9F9F9" : Colors.card,
                      flexDirection: "row",
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      height: 24,
                      borderRadius: 12,
                      backgroundColor: isSelected ? "rgba(8, 99, 118, 0.2)" : (isLight ? "#E5E5EA" : "rgba(255,255,255,0.1)"),
